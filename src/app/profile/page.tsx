...
export default function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = React.useState<"slivers" | "collections">(
    "slivers"
  );
        ...
        {activeTab === "slivers" ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {collections?.map((col) => (
              <div
                key={col.id}
                className="group bg-ash-white p-8 rounded-2xl border border-muted-silver/50 hover:border-slate-blue-gray/30 transition-all hover:shadow-md cursor-pointer relative overflow-hidden"
              >
